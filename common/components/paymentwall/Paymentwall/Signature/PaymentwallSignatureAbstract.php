<?php
namespace common\components\paymentwall\Paymentwall\Signature;

use common\components\paymentwall\Paymentwall\PaymentwallInstance;

abstract class PaymentwallSignatureAbstract extends PaymentwallInstance
{
    const VERSION_ONE = 1;
    const VERSION_TWO = 2;
