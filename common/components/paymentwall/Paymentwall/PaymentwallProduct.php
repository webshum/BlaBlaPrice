...
class PaymentwallProduct
{
    ...
    public function __construct(
        ...
        $periodType = null,
        $recurring = false,
        Paymentwall_Product $trialProduct = null
    ) {
        ...
        $this->trialProduct = ($productType == PaymentwallProduct::TYPE_SUBSCRIPTION && $recurring) ? $trialProduct : null;
    }
