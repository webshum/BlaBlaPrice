...
?>
        ...
        <?= $this->render('seller-sidebar', ['active' => 'settings']) ?>

        <div class="sidebar-content">
            <div class="float-container ">

               <div class="empty-space col-xs-b50 col-lg-b70"></div>
        <div class="container">
		...
		<div class="blabla-comment">
				...
				<?= Yii::t('app','Заповніть профіль компанії'); ?>
		</div>




                    <div class="empty-space col-xs-b20 col-lg-b30"></div>
							 ...
							 <div class="empty-space col-xs-b15 col-lg-b15"></div>
                                ...
                                <div class="simple-article large dark col-xs-b5">
                                    <h3><?= Yii::t('app', 'Особисті дані'); ?></h3>
									 ...
									 <div class="text-how-it-works"><?= Yii::t('app', 'Назва компанії та регіон будуть доступними всім зареєстрованим користувачам сервісу'); ?></div>
                                </div>
                            ...
                            <div class="row m10 ">
								...
								<div class="cust-tooltip ">
									...
									<div class="tooltip-content left-password" ">
                                                 <?= Yii::t('app', 'Назва компанії або ім’я на сайті'); ?>
                            ...
                            <div class="row m10 ">
								...
								<div class="cust-tooltip ">
                                    <?= $form->field($user, 'address')->textInput([
                                        'id' => 'user-address',
                                        'class' => 'simple-input size-5',
                                        'placeholder' => Yii::t('app', 'Ваша адреса (необов’язково)')
                                    ])->label(false) ?>
									<div class="tooltip-content left-password" ">
                                                 <?= Yii::t('app', 'Фактична адреса місцезнаходження магазину (за наявності)'); ?>

                                    </div>
									<div class="up-label"><?= Yii::t('app', 'Адреса'); ?> </div>
                                </div>
								  <div class="row text-right col-xs-b20 col-sm-b20">
                             ...
                             <div class="empty-space col-xs-b15 col-lg-b15"></div>
                                <div class="simple-article large dark col-xs-b5">
                                    <h3><?= Yii::t('app', 'Контактна інформація'); ?></h3>
									 <div class="empty-space col-xs-b5 col-lg-b5"></div>
									 <div class="text-how-it-works"><?= Yii::t('app', 'Контактні дані доступні лише потенційним клієнтам - покупцям, що погодились на пропозицію компанії'); ?></div>
...
<?php?>
                            ...
                            <div class="empty-space col-xs-b15 col-lg-b15"></div>
                             ...
                             <div class="row m10 col-xs-b40 ">
                                    ...
                                    <?= Html::input('password', 'old-password', null, [
                                        'class' => 'simple-input size-5',
                                        'id' => 'old-password',
                                        'placeholder' => Yii::t('app', 'Введіть старий пароль')
                                    ]) ?>
									 <div class="tooltip-content left-password" ">
                                                 <?= Yii::t('app', ' Для відновлення паролю натисниіть'); ?>
                                      <a class=" open-static-popup"  style="color: #0098d0;" data-rel="account-reset-password">
	 ...
	 <div class="empty-space col-xs-b90 col-sm-b90"></div>
			...
			<div class="float-container-min seller page-flash-messages">
