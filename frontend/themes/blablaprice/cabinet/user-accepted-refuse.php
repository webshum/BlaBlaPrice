                ...
                <div class="empty-space col-xs-b60 col-lg-b60"></div>
                        ...
                        <div class="tabs-block">
							<div class="popup-paddings-wide " style="padding:0">
                                ...
                                <div class="toggle">
                                    ...
                                    <a href='accepted-with-ans' class="entry tab-menu" style="max-width:31vw;">
									<?php echo Yii::t('app','Погодились'); ?></a>

                                    <a href='accepted-refuse' class="entry tab-menu active" style="max-width:31vw;">
                    ...
                    for ($i = 1; $i <= $pages->pageCount; $i++) :
                        ...
                        <a class="button <?= $active ? 'style-31' : 'style-32' ?> size-2 inline-block"
                           href="<?= Url::to(['cabinet/accepted-refuse', 'page' => $i]) ?>">
                            <span><?= $i ?></span>
                        </a>
                        <?php
                        $active = false;
