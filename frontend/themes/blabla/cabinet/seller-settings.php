...
<div class="center page-settings">
    ...
    <h2 class="heading"><?= Yii::t('app', 'Заповни профіль компанії') ?></h2>

    <div class="blabla-comment dark">
        <div class="text">
            <p><?= Yii::t('app', 'Для доступу до всіх функцій сервісу необхідно заповнити профіль користувача та підтвердити контактну інформацію'); ?></p>
        </div>
    </div>
    ...
    <ul class="accordeon accordeon-settings mt40">
                    ...
                    <div class="input-group">
                        <div class="field">
                            <?php $form = ActiveForm::begin([
                                ...
                                'options' => ['class' => 'settings-update'],
                            ]) ?>

                                <?php
                                    $TextInButton = $user->getPhone();
                                    if ($user->getPhoneApproved() == '0000-00-00 00:00:00') {
                                        $tooltip = Yii::t('app', 'Телефон не підтведжений, ти не зможеш надсилати пропозиції');
                                        $confirmation = Yii::t('app', 'Не підтверджено');
                                        $TextInButton = Yii::t('app', 'Додай свій номер');
                                        $style = 'text-danger';
                                    } elseif ($user->getPhoneApproved() != '0000-00-00 00:00:00') {
                                        $style = 'text-success';
                                        $confirmation = Yii::t('app', 'Підтверджено');
                                        $tooltip = Yii::t('app', 'Все гаразд. Ти підтвердив свій телефон, і можеш надсилати пропозиції');
                                    }
                                ?>
                            ...
                            <?php $form = ActiveForm::begin([
                                ...
                                <?php
                                    if ( $user->getEmailApproved() == '0000-00-00 00:00:00' ) {
                                        ...
                                        $confirmation = Yii::t('app', 'Підтверджено');
                                        $tooltip = Yii::t('app', ' Все гаразд , ти підтвердив свій e-mail');
                                        $style = 'text-success';
                                    }
                                ?>
        ...
        <li class="item-accordeon ">
            ...
            <div class="content-accordeon">
                <div class="inner-accordeon">
                    <p class="text-small"><?= Yii::t('app', 'Назва компанії та регіон будуть доступними всім зареєстрованим користувачам сервісу'); ?></p>
                    ...
                    <?php $form = ActiveForm::begin([
                        ...
                        <div class="input-group">
                            <div class="field">
                                <div class="input-label"><?= Yii::t('app', "Ім'я") ?></div>
                            ...
                            <div class="field">
                                <div class="input-label"><?= Yii::t('app', 'Адреса') ?></div>
                                <?= $form->field($user, 'address')->textInput([
                                    'id' => 'user-address',
                                    'class' => 'input white',
                                    'placeholder' => Yii::t('app', 'Адреса (необов’язково)')
                                ])->label(false) ?>
                            </div>
                        ...
                        <div class="input-group">
                            <div class="field">
                                ...
                                <?= Html::input('password', 'old-password', null, [
                                    'class' => 'input white',
                                    'id' => 'old-password',
                                    'placeholder' => Yii::t('app', 'Введи старий пароль')
                                ]) ?>
                            </div>
                            ...
                            <div class="field">
                                <div class="input-label">
                                    <?= Yii::t('app', 'Повтори новий пароль') ?>
                                </div>

                                <?= Html::input('password', 'confirm-password', null, [
                                    'class' => 'input white',
                                    'id' => 'confirm-password',
                                    'placeholder' => Yii::t('app', 'Повтори новий пароль')
                                ]) ?>
                            </div>
                        </div>
